...
use EasySwoole\Log\Logger as Logger2;
...
class Casbin
{
    ...
    public function __construct(?Config $config = null)
    {
        ...
        //$logger = Logger::getInstance(new Logger2());
        //$logger = new Logger();
        $test = \EasySwoole\Permission\Logger::getInstance();
        Log::setLogger(new LoggerBridge($test));

        // if ($logger = $this->config->getLogLogger()) {
        //     if (is_string($logger)) {
